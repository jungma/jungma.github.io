...
var wheelImageName   = "http://polly90.com/im.png";	// File name of the image for the wheel.
...
prizes[0] = {"name" : "파리바게뜨 케이크", "startAngle" : 332,   "endAngle" : 28.9};  // Note how prize end angle is 1 less than start angle of next prize so no overlap.
prizes[1] = {"name" : "양육검사 1종 이용권", "startAngle" : 29,  "endAngle" : 90.9};
prizes[2] = {"name" : "호비 애니메이션 1일 무제한 이용권", "startAngle" : 91, "endAngle" : 151.9};
prizes[3] = {"name" : "파리바게뜨 아메리카노", "startAngle" : 12, "endAngle" : 208.9};
prizes[4] = {"name" : "프린트학습지 3개월 무제한 이용권", "startAngle" : 209, "endAngle" : 270.9};
prizes[5] = {"name" : "20 마일리지", "startAngle" : 271, "endAngle" : 331.9};
...
function initialDraw(e)
{
	...
	surfaceContext.drawImage(wheel, 0, 0, 310, 310);
}
...
{	
	...
	surfaceContext.translate(310 * 0.5, 310 * 0.5);
